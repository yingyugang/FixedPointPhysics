    ...
    public struct FixedPointQuaternion
    {
        ...
        public FixedPointVector3 eulerAngles {
            get {
                ...
                FixedPoint64 ysqr = y * y;
                FixedPoint64 t0 = -2.0f * (ysqr + z * z) + 1.0f;
                FixedPoint64 t1 = +2.0f * (x * y - w * z);
                FixedPoint64 t2 = -2.0f * (x * z + w * y);
                FixedPoint64 t3 = +2.0f * (y * z - w * x);
                FixedPoint64 t4 = -2.0f * (x * x + ysqr) + 1.0f;
        ...
        public static FixedPointVector3 operator *(FixedPointQuaternion quat, FixedPointVector3 vec) {
            FixedPoint64 num = quat.x * 2f;
            FixedPoint64 num2 = quat.y * 2f;
            FixedPoint64 num3 = quat.z * 2f;
            FixedPoint64 num4 = quat.x * num;
            FixedPoint64 num5 = quat.y * num2;
            FixedPoint64 num6 = quat.z * num3;
            FixedPoint64 num7 = quat.x * num2;
            FixedPoint64 num8 = quat.x * num3;
            FixedPoint64 num9 = quat.y * num3;
            FixedPoint64 num10 = quat.w * num;
            FixedPoint64 num11 = quat.w * num2;
            FixedPoint64 num12 = quat.w * num3;
