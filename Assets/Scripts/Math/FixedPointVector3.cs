...
namespace BlueNoah.Math.FixedPoint
{
    ...
    public struct FixedPointVector3
    {
        ...
        {
            FixedPoint64 num0 = ((position.x * matrix.M11) + (position.y * matrix.M21)) + (position.z * matrix.M31);
            FixedPoint64 num1 = ((position.x * matrix.M12) + (position.y * matrix.M22)) + (position.z * matrix.M32);
            FixedPoint64 num2 = ((position.x * matrix.M13) + (position.y * matrix.M23)) + (position.z * matrix.M33);
        ...
        {
            FixedPoint64 num0 = ((position.x * matrix.M11) + (position.y * matrix.M12)) + (position.z * matrix.M13);
            FixedPoint64 num1 = ((position.x * matrix.M21) + (position.y * matrix.M22)) + (position.z * matrix.M23);
            FixedPoint64 num2 = ((position.x * matrix.M31) + (position.y * matrix.M32)) + (position.z * matrix.M33);
        ...
        {
            FixedPoint64 num0 = -value.x;
            FixedPoint64 num1 = -value.y;
            FixedPoint64 num2 = -value.z;
        ...
        {
            FixedPoint64 num2 = ((this.x * this.x) + (this.y * this.y)) + (this.z * this.z);
            FixedPoint64 num = FixedPoint64.One / FixedPoint64.Sqrt(num2);
            this.x *= num;
            this.y *= num;
            this.z *= num;
        }
        ...
        {
            FixedPoint64 num2 = ((value.x * value.x) + (value.y * value.y)) + (value.z * value.z);
            FixedPoint64 num = FixedPoint64.One / FixedPoint64.Sqrt(num2);
