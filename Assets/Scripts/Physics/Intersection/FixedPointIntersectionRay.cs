...
namespace BlueNoah.PhysicsEngine
{
    public partial class FixedPointIntersection
    {
        ...
        //TODO fix when x,y,or z equil 0;
        ...
        public static FixedPoint64 IntersectWithRayAndAABBFixedPoint(
            ...
            FixedPointVector3 min,
            FixedPointVector3 max,
            out FixedPointCollision intersection//optionally , the intersection is returned
            )
        {
            ...
            out FixedPointCollision intersection)
        {
            ...
            FixedPointVector3[] normals = { axisX, axisX * -1, axisY, axisY * -1, axisZ, axisZ * -1 };
            if (f.x == 0)
            {
        ...
        public static bool IntersetWithRayAndSphereFixedPoint(FixedPointVector3 origin, FixedPointVector3 direct, FixedPoint64 length, FixedPointVector3 center, FixedPoint64 radius, out FixedPointCollision intersection)
        {
            intersection = new FixedPointCollision();
            var e = center - origin;
