...
namespace BlueNoah.PhysicsEngine
{
    public class PhysicsIntersectionAABBAndOBBExample : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            obb.fixedPointOBBCollider.orientation = FixedPointMatrix.CreateFromYawPitchRoll(obb.transform.eulerAngles.y * FixedPointMath.Deg2Rad, obb.transform.eulerAngles.x * FixedPointMath.Deg2Rad, obb.transform.eulerAngles.z * FixedPointMath.Deg2Rad);
